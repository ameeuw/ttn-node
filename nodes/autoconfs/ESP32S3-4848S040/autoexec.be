...
stat_line.set_text("ESP32S3 Tasmota")
...
def create_button_relay(label, channel)
    ...
    button.set_pos((hres-button_width)/2,row_y)                                         # position of button
    button.set_size(button_width, button_height)                                         # size of button
...
buttons.push(create_button_relay("Screen", 3))
buttons[-1][0].set_y(row_y * 4)


ledR = lv.led(scr)
ledR.set_pos(20,300)
ledR.set_color(lv.color(0xFF0000))
labelR = lv.label(scr)
labelR.set_style_text_color(lv.color(0xFFFFFF), lv.PART_MAIN)
labelR.set_pos(60,300)
labelR.set_text("Red (0xFF0000)")

ledG = lv.led(scr)
ledG.set_pos(20,340)
ledG.set_color(lv.color(0x00FF00))
labelG = lv.label(scr)
labelG.set_style_text_color(lv.color(0xFFFFFF), lv.PART_MAIN)
labelG.set_pos(60,340)
labelG.set_text("Green (0x00FF00)")


ledB = lv.led(scr)
ledB.set_pos(20,380)
ledB.set_color(lv.color(0x0000FF))
labelB = lv.label(scr)
labelB.set_style_text_color(lv.color(0xFFFFFF), lv.PART_MAIN)
labelB.set_pos(60,380)
labelB.set_text("Blue (0x0000FF)")